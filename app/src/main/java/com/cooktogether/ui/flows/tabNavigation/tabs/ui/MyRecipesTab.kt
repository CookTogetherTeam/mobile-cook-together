...
object MyRecipesTab : CookTogetherTab {
    private fun readResolve(): Any = HomeTab

    override val options: TabOptions
        @Composable
        get() {
            val icon = rememberVectorPainter(ImageVector.vectorResource(R.drawable.ic_document))
            val option =
                TabOptions(
                    index = 0u,
                    title = tabNavigationStrings.myRecipes,
                    icon = icon,
                )
